...
function Router({ initialArticle, initialNotFoundPath, initialInsights }: { initialArticle?: InitialPublishedArticle | null; initialNotFoundPath?: string | null; initialInsights?: InitialPublishedArticle[] }) {
...
function App({
  ...
  return <ErrorBoundary><ThemeProvider defaultTheme="light"><LegacyContentProvider initialPayload={legacyContent}><Router initialArticle={initialArticle} initialNotFoundPath={initialNotFoundPath} initialInsights={initialInsights} /></LegacyContentProvider></ThemeProvider></ErrorBoundary>;
}
